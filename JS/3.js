...
// В JavaScript переменная не ассоциируется 
// с каким-либо типом данных, тип есть у её 
// значения. То есть переменная может хранить 
...
// Boolean - логический тип данных, флаги состояния. Всего два значения:
//  true и false. Например, на вопрос включен ли свет в комнате можно 
//  ответить да (true) или нет (false).
// Числа
// const age = 20;
...
// Задание
// Объяви следующие переменные используя ключевое слово const или let и 
// присвой им соответствующие значения.
