...
// (параметр message) и форматирует её,
...
// Вызов функции formatMessage('Curabitur ligula sapien', 16) 
// возвращает 'Curabitur ligula...'.
// Вызов функции formatMessage('Curabitur ligula sapien', 23) 
// возвращает 'Curabitur ligula sapien'.
// Вызов функции formatMessage('Vestibulum facilisis purus nec', 20) 
// возвращает 'Vestibulum facilisis...'.
// Вызов функции formatMessage('Vestibulum facilisis purus nec', 30) 
// возвращает 'Vestibulum facilisis purus nec'.
// Вызов функции formatMessage('Nunc sed turpis a felis in nunc fringilla', 15) 
// возвращает 'Nunc sed turpis...'.
// Вызов функции formatMessage('Nunc sed turpis a felis in nunc fringilla', 41) 
