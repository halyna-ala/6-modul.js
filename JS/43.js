...
// Вызов функции с указанным массивом пользователей возвращает массив ['Adrian Cross', 'Aisha 
// Tran', 'Briana Decker', 'Eddie Strong', 'Goldie Gentry', 'Jacklyn Lucas', 'Jordan Sampson',
...
//     [...users]
//     .flatMap(user=> user.friends)
//    .find((friend, index, array)=> array.indexOf(friend) === index)
//    .sort((firstfriend, secondFriend)=> firstfriend.friends.localeCompare(secondFriend.friends))
//  };
//  console.log(getSortedFriends);